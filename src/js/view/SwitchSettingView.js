...
class SwitchSettingView {
    ...
    bindSwitchSetting(settingId, initialValue, listener) {
        const mdcSwitch = new mdc.switchControl.MDCSwitch(document.querySelector(`#setting__${settingId}`))
        mdcSwitch.checked = initialValue
        mdcSwitch.listen("change", (e) => { listener(mdcSwitch.checked) })
    }
}